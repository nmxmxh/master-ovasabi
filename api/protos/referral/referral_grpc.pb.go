...
const (
	...
	ReferralService_ApplyReferral_FullMethodName    = "/referral.ReferralService/ApplyReferral"
...
type ReferralServiceClient interface {
	...
	ApplyReferral(ctx context.Context, in *ApplyReferralRequest, opts ...grpc.CallOption) (*ApplyReferralResponse, error)
...
func (c *referralServiceClient) ApplyReferral(ctx context.Context, in *ApplyReferralRequest, opts ...grpc.CallOption) (*ApplyReferralResponse, error) {
	out := new(ApplyReferralResponse)
	err := c.cc.Invoke(ctx, ReferralService_ApplyReferral_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReferralServiceServer interface {
	...
	// ApplyReferral applies a referral code
	ApplyReferral(context.Context, *ApplyReferralRequest) (*ApplyReferralResponse, error)
	// GetReferralStats retrieves referral statistics
...
func (UnimplementedReferralServiceServer) ApplyReferral(context.Context, *ApplyReferralRequest) (*ApplyReferralResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ApplyReferral not implemented")
}
...
func _ReferralService_ApplyReferral_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ApplyReferralRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReferralServiceServer).ApplyReferral(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReferralService_ApplyReferral_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReferralServiceServer).ApplyReferral(ctx, req.(*ApplyReferralRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ReferralService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ApplyReferral",
			Handler:    _ReferralService_ApplyReferral_Handler,
		},
		{
	...
	Metadata: "api/protos/referral/referral.proto",
}
