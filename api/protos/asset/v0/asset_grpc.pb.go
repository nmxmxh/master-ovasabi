...
type AssetServiceClient interface {
	...
	StreamAssetChunk(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[AssetChunk, emptypb.Empty], error)
	...
	StreamAssetContent(ctx context.Context, in *GetAssetRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AssetChunk], error)
	// Delete an asset
	...
	SubscribeToUserAssets(ctx context.Context, in *SubscribeToUserAssetsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AssetUpdate], error)
	// Subscribe to system asset updates stream
	SubscribeToSystemAssets(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AssetUpdate], error)
...
func (c *assetServiceClient) StreamAssetChunk(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[AssetChunk, emptypb.Empty], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AssetService_ServiceDesc.Streams[0], AssetService_StreamAssetChunk_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[AssetChunk, emptypb.Empty]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AssetService_StreamAssetChunkClient = grpc.ClientStreamingClient[AssetChunk, emptypb.Empty]
...
func (c *assetServiceClient) StreamAssetContent(ctx context.Context, in *GetAssetRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AssetChunk], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AssetService_ServiceDesc.Streams[1], AssetService_StreamAssetContent_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetAssetRequest, AssetChunk]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AssetService_StreamAssetContentClient = grpc.ServerStreamingClient[AssetChunk]
...
func (c *assetServiceClient) SubscribeToUserAssets(ctx context.Context, in *SubscribeToUserAssetsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AssetUpdate], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AssetService_ServiceDesc.Streams[2], AssetService_SubscribeToUserAssets_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeToUserAssetsRequest, AssetUpdate]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AssetService_SubscribeToUserAssetsClient = grpc.ServerStreamingClient[AssetUpdate]

func (c *assetServiceClient) SubscribeToSystemAssets(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AssetUpdate], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AssetService_ServiceDesc.Streams[3], AssetService_SubscribeToSystemAssets_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[emptypb.Empty, AssetUpdate]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AssetService_SubscribeToSystemAssetsClient = grpc.ServerStreamingClient[AssetUpdate]
...
type AssetServiceServer interface {
	...
	// Stream chunks for a heavy asset upload
	StreamAssetChunk(grpc.ClientStreamingServer[AssetChunk, emptypb.Empty]) error
	// Complete a heavy asset upload
	...
	// Stream asset content
	StreamAssetContent(*GetAssetRequest, grpc.ServerStreamingServer[AssetChunk]) error
	// Delete an asset
	...
	// Subscribe to user asset updates stream
	SubscribeToUserAssets(*SubscribeToUserAssetsRequest, grpc.ServerStreamingServer[AssetUpdate]) error
	// Subscribe to system asset updates stream
	SubscribeToSystemAssets(*emptypb.Empty, grpc.ServerStreamingServer[AssetUpdate]) error
	// Broadcast a system asset to all subscribers
...
func (UnimplementedAssetServiceServer) StreamAssetChunk(grpc.ClientStreamingServer[AssetChunk, emptypb.Empty]) error {
...
func (UnimplementedAssetServiceServer) StreamAssetContent(*GetAssetRequest, grpc.ServerStreamingServer[AssetChunk]) error {
...
func (UnimplementedAssetServiceServer) SubscribeToUserAssets(*SubscribeToUserAssetsRequest, grpc.ServerStreamingServer[AssetUpdate]) error {
	return status.Errorf(codes.Unimplemented, "method SubscribeToUserAssets not implemented")
}
func (UnimplementedAssetServiceServer) SubscribeToSystemAssets(*emptypb.Empty, grpc.ServerStreamingServer[AssetUpdate]) error {
...
func _AssetService_StreamAssetChunk_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AssetServiceServer).StreamAssetChunk(&grpc.GenericServerStream[AssetChunk, emptypb.Empty]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AssetService_StreamAssetChunkServer = grpc.ClientStreamingServer[AssetChunk, emptypb.Empty]
...
func _AssetService_StreamAssetContent_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(AssetServiceServer).StreamAssetContent(m, &grpc.GenericServerStream[GetAssetRequest, AssetChunk]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AssetService_StreamAssetContentServer = grpc.ServerStreamingServer[AssetChunk]
...
func _AssetService_SubscribeToUserAssets_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(AssetServiceServer).SubscribeToUserAssets(m, &grpc.GenericServerStream[SubscribeToUserAssetsRequest, AssetUpdate]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AssetService_SubscribeToUserAssetsServer = grpc.ServerStreamingServer[AssetUpdate]
...
func _AssetService_SubscribeToSystemAssets_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(AssetServiceServer).SubscribeToSystemAssets(m, &grpc.GenericServerStream[emptypb.Empty, AssetUpdate]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AssetService_SubscribeToSystemAssetsServer = grpc.ServerStreamingServer[AssetUpdate]
