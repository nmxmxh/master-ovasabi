...
type BroadcastServiceClient interface {
	...
	SubscribeToActions(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ActionSummary], error)
	...
	SubscribeToLiveAssetChunks(ctx context.Context, in *SubscribeToLiveAssetChunksRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AssetChunk], error)
...
func (c *broadcastServiceClient) SubscribeToActions(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ActionSummary], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[SubscribeRequest, ActionSummary]{ClientStream: stream}
...
type BroadcastService_SubscribeToActionsClient = grpc.ServerStreamingClient[ActionSummary]
...
func (c *broadcastServiceClient) SubscribeToLiveAssetChunks(ctx context.Context, in *SubscribeToLiveAssetChunksRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AssetChunk], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[SubscribeToLiveAssetChunksRequest, AssetChunk]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BroadcastService_SubscribeToLiveAssetChunksClient = grpc.ServerStreamingClient[AssetChunk]
...
type BroadcastServiceServer interface {
	...
	// SubscribeToActions subscribes to receive action broadcasts
	SubscribeToActions(*SubscribeRequest, grpc.ServerStreamingServer[ActionSummary]) error
	...
	// Real-time asset chunk streaming
	SubscribeToLiveAssetChunks(*SubscribeToLiveAssetChunksRequest, grpc.ServerStreamingServer[AssetChunk]) error
...
func (UnimplementedBroadcastServiceServer) SubscribeToActions(*SubscribeRequest, grpc.ServerStreamingServer[ActionSummary]) error {
...
func (UnimplementedBroadcastServiceServer) SubscribeToLiveAssetChunks(*SubscribeToLiveAssetChunksRequest, grpc.ServerStreamingServer[AssetChunk]) error {
...
func _BroadcastService_SubscribeToActions_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(BroadcastServiceServer).SubscribeToActions(m, &grpc.GenericServerStream[SubscribeRequest, ActionSummary]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BroadcastService_SubscribeToActionsServer = grpc.ServerStreamingServer[ActionSummary]
...
func _BroadcastService_SubscribeToLiveAssetChunks_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(BroadcastServiceServer).SubscribeToLiveAssetChunks(m, &grpc.GenericServerStream[SubscribeToLiveAssetChunksRequest, AssetChunk]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BroadcastService_SubscribeToLiveAssetChunksServer = grpc.ServerStreamingServer[AssetChunk]
