...
const file_nexus_v1_nexus_proto_rawDesc = "" +
	...
	"\x06result\x18\x02 \x03(\v2,.nexus.v1.ExecutePatternResponse.ResultEntryR\x06result\x1a9\n" +
	...
	"\fpattern_type\x18\x02 \x01(\tR\vpatternType\x12Z\n" +
	"\x0epattern_config\x18\x03 \x03(\v23.nexus.v1.RegisterPatternRequest.PatternConfigEntryR\rpatternConfig\x1a@\n" +
...
var file_nexus_v1_nexus_proto_goTypes = []any{
	...
	nil,                             // 6: nexus.v1.ExecutePatternRequest.ParametersEntry
	nil,                             // 7: nexus.v1.ExecutePatternResponse.ResultEntry
	nil,                             // 8: nexus.v1.RegisterPatternRequest.PatternConfigEntry
	nil,                             // 9: nexus.v1.GetKnowledgeResponse.DataEntry
}
var file_nexus_v1_nexus_proto_depIdxs = []int32{
	6, // 0: nexus.v1.ExecutePatternRequest.parameters:type_name -> nexus.v1.ExecutePatternRequest.ParametersEntry
	7, // 1: nexus.v1.ExecutePatternResponse.result:type_name -> nexus.v1.ExecutePatternResponse.ResultEntry
	8, // 2: nexus.v1.RegisterPatternRequest.pattern_config:type_name -> nexus.v1.RegisterPatternRequest.PatternConfigEntry
	9, // 3: nexus.v1.GetKnowledgeResponse.data:type_name -> nexus.v1.GetKnowledgeResponse.DataEntry
	0, // 4: nexus.v1.NexusService.ExecutePattern:input_type -> nexus.v1.ExecutePatternRequest
	2, // 5: nexus.v1.NexusService.RegisterPattern:input_type -> nexus.v1.RegisterPatternRequest
	4, // 6: nexus.v1.NexusService.GetKnowledge:input_type -> nexus.v1.GetKnowledgeRequest
	1, // 7: nexus.v1.NexusService.ExecutePattern:output_type -> nexus.v1.ExecutePatternResponse
	3, // 8: nexus.v1.NexusService.RegisterPattern:output_type -> nexus.v1.RegisterPatternResponse
	5, // 9: nexus.v1.NexusService.GetKnowledge:output_type -> nexus.v1.GetKnowledgeResponse
