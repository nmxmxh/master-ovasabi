...
type SecurityServiceClient interface {
	...
	GetAuditLog(ctx context.Context, in *AuditLogRequest, opts ...grpc.CallOption) (SecurityService_GetAuditLogClient, error)
	// Security Metrics
...
func (c *securityServiceClient) Authorize(ctx context.Context, in *AuthorizationRequest, opts ...grpc.CallOption) (*AuthorizationResponse, error) {
	...
	err := c.cc.Invoke(ctx, SecurityService_Authorize_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *securityServiceClient) ValidateToken(ctx context.Context, in *TokenValidationRequest, opts ...grpc.CallOption) (*TokenValidationResponse, error) {
	...
	err := c.cc.Invoke(ctx, SecurityService_ValidateToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *securityServiceClient) DetectThreats(ctx context.Context, in *ThreatDetectionRequest, opts ...grpc.CallOption) (*ThreatDetectionResponse, error) {
	...
	err := c.cc.Invoke(ctx, SecurityService_DetectThreats_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *securityServiceClient) ReportIncident(ctx context.Context, in *IncidentReport, opts ...grpc.CallOption) (*IncidentResponse, error) {
	...
	err := c.cc.Invoke(ctx, SecurityService_ReportIncident_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *securityServiceClient) RegisterSecurityPattern(ctx context.Context, in *SecurityPattern, opts ...grpc.CallOption) (*PatternRegistrationResponse, error) {
	...
	err := c.cc.Invoke(ctx, SecurityService_RegisterSecurityPattern_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *securityServiceClient) ValidatePattern(ctx context.Context, in *PatternValidationRequest, opts ...grpc.CallOption) (*PatternValidationResponse, error) {
	...
	err := c.cc.Invoke(ctx, SecurityService_ValidatePattern_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *securityServiceClient) RecordAuditEvent(ctx context.Context, in *AuditEvent, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, SecurityService_RecordAuditEvent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *securityServiceClient) GetAuditLog(ctx context.Context, in *AuditLogRequest, opts ...grpc.CallOption) (SecurityService_GetAuditLogClient, error) {
	stream, err := c.cc.NewStream(ctx, &SecurityService_ServiceDesc.Streams[0], SecurityService_GetAuditLog_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &securityServiceGetAuditLogClient{stream}
...
type SecurityService_GetAuditLogClient interface {
	Recv() (*AuditLogEntry, error)
	grpc.ClientStream
}

type securityServiceGetAuditLogClient struct {
	grpc.ClientStream
}

func (x *securityServiceGetAuditLogClient) Recv() (*AuditLogEntry, error) {
	m := new(AuditLogEntry)
...
func (c *securityServiceClient) GetSecurityMetrics(ctx context.Context, in *SecurityMetricsRequest, opts ...grpc.CallOption) (*SecurityMetricsResponse, error) {
	...
	err := c.cc.Invoke(ctx, SecurityService_GetSecurityMetrics_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SecurityServiceServer interface {
	...
	GetAuditLog(*AuditLogRequest, SecurityService_GetAuditLogServer) error
	// Security Metrics
...
func (UnimplementedSecurityServiceServer) GetAuditLog(*AuditLogRequest, SecurityService_GetAuditLogServer) error {
...
func _SecurityService_GetAuditLog_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(SecurityServiceServer).GetAuditLog(m, &securityServiceGetAuditLogServer{stream})
}

type SecurityService_GetAuditLogServer interface {
	Send(*AuditLogEntry) error
	grpc.ServerStream
}

type securityServiceGetAuditLogServer struct {
	grpc.ServerStream
}

func (x *securityServiceGetAuditLogServer) Send(m *AuditLogEntry) error {
