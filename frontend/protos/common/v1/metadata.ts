...
export interface Metadata_GlobalContext {
  userId: string;
  campaignId: string;
  correlationId: string;
  sessionId: string;
  deviceId: string;
  /** frontend, backend, wasm */
  source: string;
}
...
export const Metadata: MessageFns<Metadata> = {
  encode(message: Metadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.globalContext !== undefined) {
      Metadata_GlobalContext.encode(message.globalContext, writer.uint32(170).fork()).join();
    }
    if (message.envelopeVersion !== "") {
      writer.uint32(178).string(message.envelopeVersion);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 21: {
          ...
          message.globalContext = Metadata_GlobalContext.decode(reader, reader.uint32());
          continue;
        }
        case 22: {
          if (tag !== 178) {
          ...
          message.envelopeVersion = reader.string();
          continue;
        }
        case 23: {
          if (tag !== 186) {
  ...
  fromJSON(object: any): Metadata {
    return {
      ...
      globalContext: isSet(object.globalContext) ? Metadata_GlobalContext.fromJSON(object.globalContext) : undefined,
      envelopeVersion: isSet(object.envelopeVersion) ? globalThis.String(object.envelopeVersion) : "",
  ...
  toJSON(message: Metadata): unknown {
    ...
    if (message.globalContext !== undefined) {
      obj.globalContext = Metadata_GlobalContext.toJSON(message.globalContext);
    }
    if (message.envelopeVersion !== "") {
      obj.envelopeVersion = message.envelopeVersion;
    }
    if (message.environment !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<Metadata>, I>>(object: I): Metadata {
    ...
    message.globalContext = (object.globalContext !== undefined && object.globalContext !== null)
      ? Metadata_GlobalContext.fromPartial(object.globalContext)
      : undefined;
    message.envelopeVersion = object.envelopeVersion ?? "";
...
function createBaseMetadata_GlobalContext(): Metadata_GlobalContext {
  return { userId: "", campaignId: "", correlationId: "", sessionId: "", deviceId: "", source: "" };
}

export const Metadata_GlobalContext: MessageFns<Metadata_GlobalContext> = {
  encode(message: Metadata_GlobalContext, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Metadata_GlobalContext {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMetadata_GlobalContext();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): Metadata_GlobalContext {
    return {
  ...
  toJSON(message: Metadata_GlobalContext): unknown {
    const obj: any = {};
    if (message.userId !== "") {
  ...
  create<I extends Exact<DeepPartial<Metadata_GlobalContext>, I>>(base?: I): Metadata_GlobalContext {
    return Metadata_GlobalContext.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Metadata_GlobalContext>, I>>(object: I): Metadata_GlobalContext {
    const message = createBaseMetadata_GlobalContext();
