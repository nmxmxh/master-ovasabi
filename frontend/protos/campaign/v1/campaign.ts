...
import { Media } from "../../media/v1/media";
...
export interface Broadcast {
  /** Defaults to 'ovasabi_website' if not provided */
  campaignId: string;
  timestamp: string;
  eventType: string;
  userId: string;
  ...
  binaryPayload?: Uint8Array | undefined;
  media: Media[];
}
...
export const Campaign: MessageFns<Campaign> = {
  encode(message: Campaign, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.focus !== "") {
      writer.uint32(138).string(message.focus);
    }
    return writer;
  },
...
export const CreateCampaignRequest: MessageFns<CreateCampaignRequest> = {
  encode(message: CreateCampaignRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.focus !== "") {
      writer.uint32(98).string(message.focus);
    }
    return writer;
  },
...
function createBaseBroadcast(): Broadcast {
  return {
    campaignId: "",
    timestamp: "",
    eventType: "",
...
export const Broadcast: MessageFns<Broadcast> = {
  encode(message: Broadcast, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.jsonPayload !== undefined) {
      writer.uint32(50).string(message.jsonPayload);
    }
    if (message.binaryPayload !== undefined) {
      writer.uint32(58).bytes(message.binaryPayload);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Broadcast {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseBroadcast();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 7: {
          ...
          message.binaryPayload = reader.bytes();
          continue;
        }
        case 8: {
          if (tag !== 66) {
  ...
  fromJSON(object: any): Broadcast {
    return {
      ...
      metadata: isSet(object.metadata) ? Metadata.fromJSON(object.metadata) : undefined,
      jsonPayload: isSet(object.jsonPayload) ? globalThis.String(object.jsonPayload) : undefined,
      binaryPayload: isSet(object.binaryPayload) ? bytesFromBase64(object.binaryPayload) : undefined,
  ...
  toJSON(message: Broadcast): unknown {
    ...
    if (message.binaryPayload !== undefined) {
      obj.binaryPayload = base64FromBytes(message.binaryPayload);
    }
  ...
  create<I extends Exact<DeepPartial<Broadcast>, I>>(base?: I): Broadcast {
    return Broadcast.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Broadcast>, I>>(object: I): Broadcast {
    const message = createBaseBroadcast();
    ...
    message.binaryPayload = object.binaryPayload ?? undefined;
